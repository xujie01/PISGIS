...
define([
  ...
  './FilterManager',
    ...
    './magicgis/util/layers/GoogleLayer',
    './magicgis/util/layers/TianDiTuLayer',
    './magicgis/util/layers/A4MapLayer',
  ...
  CommonParams,GoogleLayer,TianDiTuLayer,A4MapLayer,ArcGISDynamicMapServiceLayer) {
  var instance = null,
    clazz = declare(null, {
      appConfig: null,
      mapDivId: '',
      ...
      createLayer: function(map, maptype, layerConfig) {
        var layMap = {
          ...
          baseMapLayers=this.appConfig.map.basemaps;
          operationalLayers=this.appConfig.map.operationallayers;
        /*array.forEach(operationalLayers, lang.hitch(this, function (operationalLayer) {
         ...
         //operationalLayer.layerObject=layer;
         }));*/
          var itemInfo={
              item:{thumbnail:null},
              itemData :{
          ...
          if (layerConfig.type == "googlemap" || layerConfig.type == "googleimage" || layerConfig.type == "googletrain") {
              ...
              map.addLayer(layer);
              if (layerConfig.type == "googleimage"||layerConfig.type == "googletrain" )
              {
                  layer = new GoogleLayer();//
          ...
          else if(layerConfig.type == "tianditumap" || layerConfig.type == "tiandituimage" || layerConfig.type == "tianditutrain")
          {
              ...
              require([layMap[maptype + '_' + layerConfig.type]], lang.hitch(this, function(layerClass) {
                  if(layerConfig.noLayer == "true")return;
                  ...
                  if(subLayers&&CommonParams.getInstance().unitId){
                      var subLayersArr=subLayers.split(",");
                      var layerDefinitions = [];
                      for(var i=0;i<subLayersArr.length;i++){
                          layerDefinitions[subLayersArr[i]] = "UNITID like '"+CommonParams.getInstance().unitId+"%'";
                      }
