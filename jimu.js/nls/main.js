define({
  root: ({
    ...
    editinfo: {
        ...
        see:"Other see",
        featureType0:"No",
        featureType1:"Third party damage",
        featureType2:"Landslide",
        featureType3:"Flood",
        featureType4:"Occupy",
        name:"Name",
        type:"Type",
        unit:"Unit",
        describ:"Dscrib",
        scropvisible:"Visible",
        save:"Save",
        shapeedit:"Shape edit",
        move:"Move",
        rotation:"Rotation / stretching",
      ...
      location: {
          ...
          lon: "Longitude",
          lat: "Latitude",
          mapPoint: "Click on map selection",
          checkLatLabel: "Please enter the correct longitude",
          picLocation: "Extracting photo coordinates",
          imgPreview: "Picture preview",
          imgType: "Picture type must be.Gif, JPEG, JPG, PNG in one of the",
          noImg: "No files selected",
          noGPS:"Photos without GPS location information!"
      },
      pipedijit: {
          filter:"Key world to filter..",
          cancel:"Cancel",
          ok:"Ok",
          leaftip:"Only to select leafNode",
          markername:"Marker",
          station:"Station",
          type:"Markertype",
          name:"Name"
