define([
  ...
  var PrintDijit = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    //浏览器打印，div打印
    printer: function() {
        PanelManager.getInstance().minimizePanel("_18_panel");//左边框ID
        PanelManager.getInstance().closePanel("widgets_Print_Widget_21_panel");//打印widget ID
