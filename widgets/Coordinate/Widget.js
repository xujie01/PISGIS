      ...
      */
      ...
      _processData: function() {
        ...
        if (!(this.config.spatialReferences && this.config.spatialReferences.length)) {
            ...
            var isBingMap = basemap && (basemap.type === "BingMapsRoad" ||
                basemap.type === "BingMapsHybrid" || basemap.type === "BingMapsAerial");
            var isWebTiled = basemap && (basemap.type === 'WebTiledLayer'|| basemap.type == "googlemap" || basemap.type == "googleimage" ||
                basemap.type == "googletrain" || basemap.type == "googleabc" || basemap.type == "tianditumap" || basemap.type == "tiandituimage" ||
                basemap.type == "tianditutrain" || basemap.type=="a4map"||basemap.type=="a4image"||basemap.type=="a4train");
            var isVectorTile = basemap && basemap.type === 'VectorTileLayer';
            if (basemap && basemap.url) {
                esriRequest({
                    url: basemap.url,
